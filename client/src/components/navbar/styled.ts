...
export const AppBar = styled(MuiAppBar)`
  background: ${(props: any): string => props.theme.header.background};
  color: ${(props: any): string => props.theme.header.color};
`;
...
export const ThemeSwitch = styled(Switch)(({ theme }) => ({
  ...
  "& .MuiSwitch-thumb": {
    backgroundColor: theme.palette.mode === "dark" ? "#003892" : "#b2a300",
    width: 32,
    height: 32,
    "&:before": {
      content: "''",
